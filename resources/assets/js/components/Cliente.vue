                    ...
                    <div class="modal-body">
                        <div class="col-lg-12">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="descripcion" class=" form-control-label">Nro. Documento</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="descripcion" class="form-control" v-model="num_documento">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="descripcion" class=" form-control-label">Dirección</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="descripcion" class="form-control" v-model="direccion">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label for="descripcion" class=" form-control-label">Celular</label>
                                    </div>
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="descripcion" class="form-control" v-model="telefono">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="descripcion" class="form-control" v-model="email">
                                    </div>
                                </div>
