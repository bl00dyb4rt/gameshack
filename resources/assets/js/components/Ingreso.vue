            ...
            <template v-if="listado==1">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h3 class="title-5 m-b-35">Ingresos</h3>
                        ...
                        <div class="table-data__tool">
                            <div class="table-data__tool-left">
                                ...
                                <div class="rs-select2--light rs-select2--md">
                                    <input type="text" class="form-control" v-model="buscar" @keyup.enter="listarIngreso(1,buscar,criterio)">
                                </div>
                                <div class="rs-select2--light">
                                    <button type="submit" @click="listarIngreso(1,buscar,criterio)" class="au-btn-filter" >
                        ...
                        <div class="table-responsive table-responsive-data2">
                            <table class="table table-data2">
                                ...
                                <tbody>
                                    <tr class="tr-shadow" v-for="ingreso in arrayIngreso" :key="ingreso.id">
                                        ...
                                        <td style="text-align: center;">
                                            <div class="table-data-feature">
                                                <button type="button" @click="verIngreso(ingreso.id)" class="item" title="Ver">
                                                    <i class="zmdi zmdi-eye" style="color:#007bff"></i>
                                                </button>
                                                <template v-if="ingreso.estado=='Registrado'">
                                                    <button type="button" @click="desactivarIngreso(ingreso.id)" class="item" title="Desactivar">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong>Formulario de Ingresos</strong>
                            </div>
                            <div class="card-body card-block">
                                    <div class="row form-group">
                                        <div class="col-sm-8">
                                            ...
                                            <select id="proveedores" class="form-control" v-model="idproveedor">
                                    ...
                                    <div v-show="errorIngreso" class="row form-group">
                                        <div class="col-md-12">
                                            <center>
                                                <div style="color: red; text-align: center" v-for="error in errorMostrarMsjIngreso" :key="error" v-text="error">
                                                ...
                                                <table class="table table-borderless table-striped table-earning">
                                                    ...
                                                    <tbody v-if="arrayDetalle.length">
                                                        <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                                            ...
                                                            <td style="text-align: center"><input type="number" class="form-control" v-model="detalle.precio"></td>
            ...
            <template v-else-if="listado==2">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong>Ingreso detallado</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="" method="post" class="">
                                    <div class="row form-group">
                                        <div class="col-sm-8">
                                            <label class=" form-control-label">Proveedor</label>
                                            <input type="text" v-model="proveedor" readonly class="form-control">
                                        </div>
                                        <div class="col-sm-4">
                                            <label class=" form-control-label">Impuesto</label>
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            selectProveedor(){
                let me=this;
                var url= this.ruta+'/proveedor/selectProveedor';
                axios.get(url).then(function (response) {
                    var respuesta= response.data;
                    me.arrayProveedor = respuesta.proveedores;
                })
